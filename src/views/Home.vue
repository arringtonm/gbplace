<template>
  <div class="home">
    <!-- <Carousel image="carousel-dosha.jpg"/> -->
    ...
    return {
      ...
      projectsTDD: {
        ...
        target: {
          ...
          imagepath: "InterchangeMay2014.jpg",
          imagecredit: false,
          key: 9
        },
        westside: {
          ...
          imagepath: "BeachSunSetdabs171a_edited-1.jpg",
          imagecredit: false,
          key: 10
        }
      },
      slides: [
        {
          image: "NewLynnNewZealandweb-min.jpg",
          caption: "\"the world’s foremost authority on TOD policy, design and implementation.\"",
          captionsayer: "Urban Development Institute of Australia",
          id: 1
        },
        {
          image: "tysonWest_v1-min.jpg",
          caption: "GB’s plan is transforming Tysons Corner into America’s largest TOD",
          captionsayer: "\"10 Ideas for Changing the World Right Now.\"  Time Magazine",
          imagecredit: "Fairfax County",
          id: 2
        },
        {
          image: "1510Web-min.jpg",
          caption: "GB’s work changed the face of transit and land use in Portland",
          captionsayer: "Presidential Design Award, The White House, Westside Light Rail",
          id: 3
        }
      ]
    };
